...
const FavoritesPage = observer(() => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8 text-gray-900 dark:text-gray-100">Избранные фильмы</h2>
      {favoriteStore.favorites.length === 0 ? (
        <p className="text-center text-gray-500 dark:text-gray-400 text-base sm:text-lg">Нет избранных фильмов</p>
      ) : (
